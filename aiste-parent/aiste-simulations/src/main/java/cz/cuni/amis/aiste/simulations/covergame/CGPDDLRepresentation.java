...
public class CGPDDLRepresentation extends AbstractCGPlanningRepresentation<PDDLDomain, PDDLProblem, ActionDescription>
    implements ISimulablePDDLRepresentation<CGAction, CoverGame, CGPlanningGoal> {
    ...
    @Override
    public IReactivePlan<? extends CGAction> translateAction(ActionDescription actionFromPlanner, AgentBody body) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
