 ...
 * @author 
 */
public class FPS1ReactiveController extends AbstractAgentController<FPS1Action, FPS1> {

    @Override
    public void init(IEnvironment<FPS1Action> environment, FPS1 representation, AgentBody body, long stepDelay) {
