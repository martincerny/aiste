 ...
 * @author Martin Cerny
 */
public class EnvironmentSpecificAgentController extends AbstractAgentController<IAction, IEnvironmentSpecificRepresentation> {

    @Override
    public Class getRepresentationClass() {
        return  IEnvironmentSpecificRepresentation.class;
    }
    ...
    public void onSimulationStep(double reward) {
        ...
        IAction action = representation.getNextAction(body);
        if(action != null){
